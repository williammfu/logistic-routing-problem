...
## Tugas
Kita akan menggunakan dataset jalanan pada kota Oldenburg yang dapat diakses pada tautan <a href="https://www.cs.utah.edu/~lifeifei/SpatialDataset.htm">ini.</a> Lakukan pengunduhan untuk kedua data jalanan di kota Oldenburg. Data pertama merupakan koordinat simpul, data kedua merupakan data sisi antar simpul.<br>
...
## Penilaian
Saat ini, nilai belum ditentukan, akan tetapi nilai akan diberikan untuk tiap *milestone*. Penilaian akan dilakukan berdasarkan kode sumber,demo aplikasi dan pemahaman terhadap solusi masalah. Demo hanya dapat dilakukan sekali.
